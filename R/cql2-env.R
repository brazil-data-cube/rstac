...
cql2_ident_env <- function() {
  parent.env(cql2_global_env)
}

cql2_adv_comp_env <- function() {
  parent.env(cql2_ident_env())
}

cql2_core_env <- function() {
  parent.env(cql2_adv_comp_env())
}
