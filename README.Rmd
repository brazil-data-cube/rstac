...
The code below creates a `stac` object and list the available collections of the STAC API of the Brazilian National Space Research Institute (INPE), which contains data from several image collections as well as datacubes of the the [Brazil Data Cube](https://data.inpe.br/bdc/web/en/home-page-2/) Project.
