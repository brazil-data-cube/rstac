...
The first step consists of creating a query based on the concatenation of functions that builds an endpoint. The second step consists of requesting the constructed endpoint.
...
This tutorial use the STAC API made available by the [Brazil Data Cube (BDC)](http://www.brazildatacube.org/en/home-page-2/) project. BDC is a research, development, and technological innovation project of the National Institute for 
...
s_obj
```
The `RSTACQuery` class object stores the metadata of the created query.
...
The defined query can be requested after its creation. 
